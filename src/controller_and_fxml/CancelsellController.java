...
public class CancelsellController {
        ...
        firstNameCol.setCellFactory(tc->{
            ...
            cell.setOnMouseClicked(e -> {
                        if (! cell.isEmpty()) {
                            ...
                            client.getWriteThreadClient().cancel_sell(client.find_player_from_name(c.getSell_list(),userId));
                            client.cancel_sell_now=false;
                            try {
                                client.showMainPage();
