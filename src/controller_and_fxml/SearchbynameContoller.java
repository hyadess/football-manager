...
public class SearchbynameContoller {
    ...
    public static void setC(club c) {
        SearchbynameContoller.c = c;
    }

    public static void setSearch_list(List<player> search_list) {
        SearchbynameContoller.search_list = search_list;
    }
    ...
    public void searchname(ActionEvent actionEvent) {
        ...
        try {
            search_list=c.search_player_by_name(player_name);
